...
public class ErrorList extends AppCompatActivity {
    ...
    /*public void exportToFile(View v) throws IOException {
            progressBar = (LinearProgressIndicator) findViewById(R.id.pgbExport);
    ...
    /*private void ExportThread() throws IOException {
        File folder = new File(Environment.getExternalStorageDirectory() + "/LwKontejnerExport");
        boolean isFolderExist = true;
        if (!folder.exists()) {
            //Toast.makeText(MainActivity.this, "Directory Does Not Exist, Create It", Toast.LENGTH_SHORT).show();
            isFolderExist = folder.mkdir();
        ...
        try {
            ...
            String fileName = "LwKontejnerExport" + strDate + ".csv";
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(this);
            builder1.setTitle("Export byl dokončel");
            builder1.setMessage("Data byla uložena do souboru " + folder.getName() + "/" + fileName);
            builder1.setCancelable(true);
            builder1.setNeutralButton("Zavřít",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
